...
#define MIUI_VERSION     "1.00"//lenovo-sw wangxf14
#define MIUI_BUILD       "2014-03-01"//lenovo-sw wangxf14
#define MIUI_BUILD_CN    "Weekend"
#define MIUI_BUILD_L     "Frenz"
...
//#define MIUI_THEME_CNT 55 // //lenovo-sw wangxf14 add 18 items again
#define MIUI_THEME_CNT 73 // lenovo-sw wuwl9 add 18 items again for OTA updatecartoon loading
