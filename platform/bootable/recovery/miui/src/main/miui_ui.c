...
void miui_redraw(){
  ...
  ag_rect(&miui_bg,0,0,agw(),agh(),0x0000);
	...
	{
		//-- Background
		if (!atheme_id_draw(atheme_id("img.background"), &miui_bg, 0, 0, agw(),agh())){
...
//ag_text(win,titW,elmP,elmP,bg_title,acfg()->titlefg,0);
  ...
  ag_text(win,titW,elmP,elmP,bg_title,txtcolor,0);//lenovo-sw wangxf14 add 2013-06-20, add for title
  #if 0
  //draw battery
