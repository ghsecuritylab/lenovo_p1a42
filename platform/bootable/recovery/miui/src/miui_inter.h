...
int miui_lenovo_start_install(CANVAS * bg,int x, int y, int w, int h,int echo);
int miui_lenovo_start_indeterminate_progress(CANVAS * bg,int x, int y, int w, int h,int echo, const char *ctl1, const char *ctl2);
int ag_changcolor(char ch1, char ch2, char ch3, char ch4);
int miui_button_menubox(char *title_name, char **item,  int item_cnt);
int miui_prompt(int argc, char *format, ...);
