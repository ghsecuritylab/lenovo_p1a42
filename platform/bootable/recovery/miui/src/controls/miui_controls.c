...
/* Begin, lenovo-sw wangxf14 20131010 modify, modify for lenovo spinner progress */
  ...
  "img.icon.install.normal01",
  "img.icon.install.normal02",
  "img.icon.install.normal03",
  "img.icon.install.normal04",
  "img.icon.install.normal05",
  "img.icon.install.normal06",
  "img.icon.install.normal07",
  "img.icon.install.normal08",
  "img.icon.install.normal09",
  "img.icon.install.normal10",
  "img.icon.install.normal11",
  "img.icon.install.normal12",
  "img.icon.install.normal13",
  "img.icon.install.normal14",
  "img.icon.install.normal15",
  "img.icon.install.normal16",
  "img.icon.install.normal17",
  "img.icon.install.normal18"
...
#endif
  aw_redraw(win);
//  miui_debug("acfg_var.fadeframes = %d\n", acfg_var.fadeframes);
...
/*Begin, lenovo-sw wangxf14 20130814 modify, modify for warning text */
  ...
  if( 1 == flag )
  {
        ...
        ag_texts(bg, w, ptitle_x, ptitle_y, title,txtcolor, 1);
...
/*End, lenovo-sw wangxf14 20130814 modify, modify for warning text */
 ...
 // ag_text(bg, ptext_w, ptext_x, ptext_y, text,acfg()->textfg, 0);
  ag_text(bg, ptext_w, ptext_x, ptext_y, text,txtcolor, 0);
  aw_x = x;
